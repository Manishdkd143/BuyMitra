...
import { addToCart, calculateShipping, calculateTotal, clearCart, deleteCart, getCartSummary, getUserCart, removeToCart, updateCartItemQuantity } from "../controllers/cart.controller.js";
const router=Router();
router.use(verifyJWT)
router.route("/create").post(addToCart)
router.route("/remove-product/:productId").delete(removeToCart)
...
router.route("/calculate-total").post(calculateTotal)
