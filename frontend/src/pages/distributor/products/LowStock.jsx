...
import { getLowStockProducts } from '../../../services/distributor/products.service';
...
const LowStockProducts = () => {
  ...
  const navigate=useNavigate()
   ...
   const loadLowProducts = async (page = 1, searchText = "") => {
     try {
       setLoading(true);
...
useEffect(() => {
  loadLowProducts(1,debounceSearch||"")
}, [debounceSearch])


  if (loading) {
    return <p className="text-gray-400">Loading low stock products...</p>;
  }
    ...
    <div className="flex flex-col sm:flex-row justify-between items-center gap-4 mt-6 pt-6 border-t border-slate-700">
      ...
      <div className="flex items-center gap-2">
        <button
          ...
          onClick={() =>
            loadLowProducts(meta.currentPage - 1, debounceSearch || "")
          }
